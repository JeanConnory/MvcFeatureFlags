...
namespace MvcFeatureFlags.Controllers
{
	public class ProductsController : Controller
	{
		...
		private readonly IFeatureManager _featureManager; //Usar usando injeção de dependencia

        public ProductsController(AppDbContext context, IWebHostEnvironment environment, IFeatureManager featureManager)
        {
            _context = context;
		...
		[HttpGet]
		[FeatureGate(FeatureFlags.CreateProduct)]
